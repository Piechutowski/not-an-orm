// CRUD generation (edbml_queries.go): the v0 query surface of Not an ORM.
//
...
func (e *queryEmitter) header() {
	fmt.Fprintf(&e.out, "// Code generated by edbml gen from %s; DO NOT EDIT.\n", e.opts.Source)
	e.out.WriteString("//\n// CRUD methods over the models in edbml_models.go. Identity arguments\n")
